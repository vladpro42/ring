...
export default function CatalogMainDescription({ subtitle, title, toggleFilterMobile }: Props) {
  ...
  const pagination = usePagination({
    contentPerPage: contentPerPage || 1,
